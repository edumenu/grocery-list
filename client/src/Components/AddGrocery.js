        ...
        <div className={`add-grocery overflow-y-auto max-h-screen ${addGroceryButton ? "block" : "hidden"}`} >
            <form method="POST" action="#login">
                <div className="mb-8">
                    ...
                    <input name="item" id="item" type="text" className="card_element2 block pr-10 w-3/4 py-4 px-4 text-gray-700 mb-3 appearance-none leading-tight focus:outline-none focus:border-gray-500 transition duration-500 ease-in-out" />
                </div>

                <div className="mb-8">
                    <label className="block text-gray-600 text-md font-bold mb-2"> Amount </label>
                    <input name="amount" id="amount" type="number" className="card_element2 block pr-10 w-3/4 py-4 px-4 text-gray-700 mb-3 appearance-none leading-tight focus:outline-none focus:border-gray-500 transition duration-500 ease-in-out" />
                </div>
